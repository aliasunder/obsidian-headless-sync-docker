...
> Fork of [Belphemur/obsidian-headless-sync-docker](https://github.com/Belphemur/obsidian-headless-sync-docker), maintained for [vault-cortex](https://github.com/aliasunder/vault-cortex). Images: `ghcr.io/aliasunder/obsidian-headless-sync-docker`.
